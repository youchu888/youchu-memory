...
- [ ] **设备标签 uid_map 指纹**：#8179 PASS；M1–M3 已改；**沙箱 explain 卡 new-mac→hadoop SSH banner timeout**（需 VPN/入口）；不动 full_chain。
- [ ] **归因 V1.0.11**：test 近月补数 **08-09~09-07 全 SUCCESS**（result→apply→is_run_sync）；**SR 本机不可达未验数**；验数通过后再 RP 野花。
