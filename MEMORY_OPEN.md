...
- [ ] **大漏斗注册 event_time**：stage1 仅 `run_test.sh --step=dws_app_event_funnel_metric_stg_d`（pid 362801，数据日 2026-09-11，日志 `/tmp/funnel_test_20260911.log`）。框外串宽表已停。宽表须再走 runner `--step=dws_app_event_funnel_d_d`，禁止 nohup/yarn 替跑。
