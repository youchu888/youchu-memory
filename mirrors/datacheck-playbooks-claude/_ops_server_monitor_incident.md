...
> **执行主机**：**old-mac 专责**（主人 2026-08-31；new-mac 不另建夜间巡检）  
> **权威来源**：bus#7708（狂人阶段性回执，2026-08-31）  
> **双机副本**：`~/.dc-platform/memory/playbook_server_monitor_incident.md`（经 memory-git sync）  
> **完整版 SOP**：狂人晚些补（又初 bus#7706 / #7720 追问中）  
> **关联**：[`_ops_dolphinscheduler_workflow_update.md`](./_ops_dolphinscheduler_workflow_update.md) · lesson `2026-08-31-server-monitor-incident-sop-bus7708.md`
