...
| 类型 | 触发 |
|------|------|
| 日报 | 用户说「日报/今日总结」；或 **工作日** 自动：双机冲刺（周一至周五 21:20 / 周六 18:20）→ 同步 → old-mac 写日报推 TG（周一至周五 **21:30** / 周六 **18:30**） |
| 周报 | 用户说「周报/上周总结/本周计划」 |
...
## 周报内容铁律（与日报对齐，主人 07-03/07-07/07-08 · 2026-09-07 补钉）

- **格式锁死**：标题/分区/`【本周完成】【卡点】【周日】【下周计划】【日报索引】【一句话给周会】`/计划表 **一律按模板**，禁止改成口语稿、自由段落、朗读提纲
- **内容说人话**：条目用大白话写清「做了啥、到哪一步」；禁止「沙箱挂槽 / 摘 new 切 _r / published / explain」这类术语堆砌；可念、能听懂
