...
| 2026-09-08 12:10 | 群派单#211 | worker_ant_group | in_progress | 明白，都放 test 测，需要改的就改。开工了。 改动面已经摸清，不大：七个 ETL 一共 356 行，device_id 出现 23 处（device_sig |
| 2026-09-08 12:17 | 群派单#212 | worker_ant_group | in_progress | 改 SQL 的过程中查到一个必须先跟你说的问题：指纹本身也有退化值，跟 sid 一个毛病，而且严重得多。 09-06 单日实测（dw_user_event_de |
