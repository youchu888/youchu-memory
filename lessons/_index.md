...
| 2026-09-23 | [跟用户解释/梳理时说人话，少堆术语](./2026-09-23-跟用户解释梳理时说人话-少堆术语.md) | communication,plain-language | 对话/需求梳理说人话；见 feedback_speak_plain_to_user |
| 2026-09-23 | [手动打的是前一日下班卡时，须明确不影响当日自动上下班计划与时间窗口](./2026-09-23-手动打的是前一日下班卡时-须明确不影响当日自动上下班计划与时间窗口.md) | punch,session-rotate | 会话轮换前自动蒸馏 |
| 2026-09-23 | [主人说已手动打卡时，禁止再重试或自动补打，当次打卡视为已完成](./2026-09-23-主人说已手动打卡时-禁止再重试或自动补打-当次打卡视为已完成.md) | punch,session-rotate | 会话轮换前自动蒸馏 |
...
| 2026-09-21 | [归因 prod 补数须用运营系统真 PC/WF；直连海豚常 404](./2026-09-21-attribution-prod-pc-wf-platform-api.md) | attribution,complement,dolphin,runbook,funnel | high |
...
| 2026-09-17 | [指标口径变更须先改仓库入库逻辑、验数通过后再动线上服务端](./2026-09-17-指标口径变更须先改仓库入库逻辑-验数通过后再动线上服务端.md) | 大漏斗,session-rotate | 会话轮换前自动蒸馏 |
| 2026-09-17 | [大漏斗 SQL：服务端新于仓库时先拉回入库，禁止只改服务器](./2026-09-17-大漏斗SQL须先入库再部署-禁服务端独改.md) | funnel, pipeline-runner, git, deploy | 服务端新→先拉回仓库双路径；禁直改服务器与 /tmp 绕过 |
| 2026-09-16 | [用户私聊贴完整定稿并说「按这个上传云端」时，以粘贴正文落盘再调 upload_w](./2026-09-16-用户私聊贴完整定稿并说-按这个上传云端-时-以粘贴正文落盘再调-upload_work_repo.md) | daily-report,session-rotate | 会话轮换前自动蒸馏 |
| 2026-09-16 | [恢复 is_run_sync：仅 INSERT 缺失行](./2026-09-16-恢复is_run_sync仅INSERT缺失行.md) | is_run_sync, attribution | 四条件入围；配置无行才写；不 UPDATE |
| 2026-09-16 | [做事整体偏慢：先结论、禁重探、一题一会话](./2026-09-16-长会话猜审人拖慢-先查feedback再动.md) | speed, session | 先结论；已知禁重猜；一题一会话 |
...
| 2026-09-12 | [归因入围关联须按需求沿用，不得把新 JOIN 说成旧规则](./2026-09-12-归因入围关联须按需求沿用-不得把新JOIN说成旧规则.md) | attribution, V1.0.11, enroll | 需求不改关联字段；e3c7a674 加了安装 JOIN，不是沿用 |
...
| 2026-09-11 | [运行开关只做缺失配置补全，勿全量重刷覆盖已有配置](./2026-09-11-运行开关只做缺失配置补全-勿全量重刷覆盖已有配置.md) | 归因升级,session-rotate | 会话轮换前自动蒸馏 |
